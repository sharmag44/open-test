     ...
     if (config.processors) {
          ...
          if (config.processors.default) {
               if (config.processors.default.dir) {
                    options.processors.default.dir =
                         config.processors.default.dir;
               }

               if (config.processors.default.file) {
                    options.processors.default.file =
                         config.processors.default.file;
               }
          }
     }
};
...
const handleMessage = function (data, context, callback) {
     const root = `${appRoot}/${options.processors.dir}/${paramCase(
          context.entity
     )}/${paramCase(context.action)}`;
