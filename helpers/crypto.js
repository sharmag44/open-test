...
const calculateHash = (details, isSending) => {
     ...
     var hashVarsSeq = (
          isSending ? config.hashSequence.send : config.hashSequence.recieved
     ).split('|');

     _.each(hashVarsSeq, (hashParam) => {
          //creating hashString with values//
          switch (hashParam) {
               case 'key':
               ...
               case 'productinfo':
                    hashString =
                         hashString +
                         (details.productInfo || config.productInfo) +
                         '|';
                    break;
               case 'firstname':
               ...
               case 'udf1':
                    hashString =
                         hashString +
                         (details.udf1 === undefined ? '' : details.udf1) +
                         '|';
                    break;
               ...
               case 'udf2':
                    hashString =
                         hashString +
                         (details.udf2 === undefined ? '' : details.udf2) +
                         '|';
                    break;
               ...
               case 'udf3':
                    hashString =
                         hashString +
                         (details.udf3 === undefined ? '' : details.udf3) +
                         '|';
                    break;
               ...
               case 'udf4':
                    hashString =
                         hashString +
                         (details.udf4 === undefined ? '' : details.udf4) +
                         '|';
                    break;
               ...
               case 'udf5':
                    hashString =
                         hashString +
                         (details.udf5 === undefined ? '' : details.udf5) +
                         '|';
                    break;
...
exports.dataPiping = (details) => {
     ...
     const hashVarsSeq = (
          typeof details === 'string'
               ? asiTicketConfig.hashSequence.paymentId
               : details.transactionId
               ? asiTicketConfig.hashSequence.send
               : asiTicketConfig.hashSequence.visitor
     ).split('|');
     _.each(hashVarsSeq, (hashParam) => {
          //creating hashString with values//
          switch (hashParam) {
               ...
               case 'payment.id':
                    hashString =
                         hashString +
                         (details.id || asiTicketConfig.productInfo) +
                         '|';
                    break;
               ...
               case 'payment.date':
                    hashString =
                         hashString +
                         (details.date === undefined ? '' : details.date) +
                         '|';
                    break;
               case 'monument.code':
                    hashString =
                         hashString +
                         (details.monument.code === undefined
                              ? ''
                              : details.monument.code) +
                         '|';
                    break;
               case 'date':
                    hashString =
               ...
               case 'identity.type':
                    hashString =
                         hashString +
                         (details.identity.type === undefined
                              ? ''
               ...
               case 'age':
                    hashString =
                         hashString +
                         (details.age === undefined ? '' : details.age) +
                         '|';
                    break;
               case 'country':
                    hashString =
                         hashString +
                         (details.nationality.country === undefined
                              ? ''
